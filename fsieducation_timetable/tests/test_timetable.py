...
class TestTimetable(TestTimetableCommon):
    ...
    def test_case_timetable(self):
        session = self.fsi_session.create({
            'timing_id': self.env.ref('fsieducation_timetable.fsi_timing_1').id,
            ...
            'faculty_id': self.env.ref('fsieducation_core.fsi_faculty_1').id,
            'batch_id': self.env.ref('fsieducation_core.fsi_batch_1').id,
            'subject_id': self.env.ref('fsieducation_core.fsi_subject_1').id
        })

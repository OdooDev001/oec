...
class ReportTimeTableTeacherGenerate(models.AbstractModel):
    _name = "report.fsieducation_timetable.report_timetable_teacher_generate"
    ...
    def get_full_name(self, data):
        faculty_name = self.env['fsi.faculty'].browse(data['faculty_id'][0])
    ...
    def get_object(self, data):
        data_list = []
        for timetable_obj in self.env['fsi.session'].browse(

...
class ReportTicket(models.AbstractModel):
    _name = "report.fsieducation_exam.report_ticket"
    ...
    def get_data(self, data):
        ...
        exam_session = self.env['fsi.exam.session'].search([('id', '=', active_id),('state', '=','schedule')])
        if exam_session:
            student_search = self.env['fsi.student'].search(

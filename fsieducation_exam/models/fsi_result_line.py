...
class FSIResultLine(models.Model):
    _name = "fsi.result.line"
    _rec_name = "marks"
    _description = "Result Line"

    marksheet_line_id = fields.Many2one(
        'fsi.marksheet.line', 'Marksheet Line', ondelete='cascade')
    exam_id = fields.Many2one('fsi.exam', 'Exam', required=True)

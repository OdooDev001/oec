...
class StudentAttendanceReport(models.AbstractModel):
    _name = "report.fsieducation_attendance.student_attendance_report"
    _description = "Attendance Report"

    def get_student_name(self, data):
        student = self.env['fsi.student'].browse(data['student_id'])
        if student:
            return student.name

    def get_data(self, data):

        sheet_search = self.env['fsi.attendance.sheet'].search(

# -*- coding: utf-8 -*-
# Part of fsieducation. See LICENSE file for full copyright & licensing details.
...
class FSIAcademicYear(models.Model):
    _name = 'fsi.academic.year'
    ...
    term_structure = fields.Selection([('two_sem', 'Two Semesters'),
                                      ...
                                      required=True)
    academic_term_ids = fields.One2many('fsi.academic.term', 'academic_year_id',
    ...
    def term_create(self):
        num = 0
        final = 1
        academic_terms = self.env['fsi.academic.term'].search([])

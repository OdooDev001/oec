...
class FSISubjectRegistration(models.Model):
    _name = "fsi.subject.registration"
    ...
    def action_approve(self):
        for record in self:
            ...
            for sub in record.elective_subject_ids:
                subject_ids.append(sub.id)
            course_id = self.env['fsi.student.course'].search([

...

{
    ...
    'data': [
        ...
        'views/fsi_academic_year_view.xml',
        'views/fsi_academic_term_view.xml',
        'views/program_view.xml',
        'views/program_level.xml',
        'data/ir_cron_data.xml',
        'menu/fsieducation_core_menu.xml',
    ...
    'demo': [
        ...
        'demo/fsi_academic_year_demo.xml',
        'demo/fsi_academic_term_demo.xml',
    ],
    'css': [
    ...
    'qweb': [
        ...
        'static/src/xml/dashboard_ext_fsieducation.xml'
    ],
    'js': [],
    'images': [
    ],

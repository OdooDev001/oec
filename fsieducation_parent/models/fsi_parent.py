...
class FSIParent(models.Model):
    ...
    def create_parent_user(self):
        template = self.env.ref('fsieducation_parent.parent_template_user')
...
class OpStudent(models.Model):
    ...
    parent_ids = fields.Many2many('fsi.parent', string='Parent')
    ...
    def get_parent(self):
        action = self.env.ref('fsieducation_parent.'
                              'action_open_fsi_parent_view').sudo().read()[0]

...

{
    ...
    'depends': ['fsieducation_core', 'account'],
    'data': [
    ...
    'images': [
        'static/description/fsieducation-fees_banner.jpg',
    ],
    'assets': {
        'web.assets_backend': [
            'fsieducation_fees/static/src/js/page_list.js',
            'fsieducation_fees/static/src/js/fees_term_widget.js',
            'fsieducation_fees/static/src/xml/fees_term_widget_template.xml',
        ],
    },
    'demo': [

...
class OpFeesTermsLine(models.Model):
    ...
    fees_element_line = fields.One2many("fsi.fees.element",
                                        "fees_terms_line_id", "Fees Elements")
    fees_id = fields.Many2one('fsi.fees.terms', 'Fees')


class OpFeesTerms(models.Model):
    _name = "fsi.fees.terms"
    ...
    day_type = fields.Selection([('before', 'Before'), ('after', 'After')],
                                'Type')
    line_ids = fields.One2many('fsi.fees.terms.line', 'fees_id', 'Terms')
